import { Empty, Button, Checkbox, Pagination, Select, Popconfirm } from "antd";
...
const TodoSection = () => {
  ...
  const handleDeleteTodo = (id: number) => {
    ...
    // 如果刪除後當前頁沒有數據，回到上一頁
    const remainingTodos = todos.filter((todo) => todo.id !== id).length;
    const maxPage = Math.ceil(remainingTodos / pageSize);
